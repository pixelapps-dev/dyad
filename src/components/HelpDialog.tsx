...
`;
  ...
  const renderMainScreen = () => (
    ...
    >
      <DialogHeader>
        <DialogTitle>Need help with Pagemate?</DialogTitle>
      </DialogHeader>
      <DialogDescription>
      ...
      <div className="flex flex-col w-full mt-4 space-y-5">
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          <div className="border rounded-lg p-4 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Includes error logs to troubleshoot non-AI issues with Pagemate
      ...
      >
        ...
        <div className="space-y-2 overflow-y-auto flex-grow mt-4">
          ...
          <ReviewDetailsSection title="System Information" mono={false}>
            <p>Pagemate Version: {debugBundle.system.dyadVersion}</p>
