...
export const SETTING_IDS = {
  ...
  neon: "setting-neon",
  webSearch: "setting-web-search",
  imageGeneration: "setting-image-generation",
...
export const SETTINGS_SEARCH_INDEX: SearchableSettingItem[] = [
  ...
  },
  {
    ...
    description:
      "Set the top-level folder that Pagemate will store new applications in",
  ...
  {
    id: SETTING_IDS.webSearch,
    label: "Web Search",
    description:
      "Configure API keys for Tavily, Firecrawl, or Exa to enable the web_search agent tool",
    keywords: [
      "web search",
      "tavily",
      "firecrawl",
  ...
  {
    id: SETTING_IDS.imageGeneration,
    label: "Image Generation",
    description:
      "Configure API keys for OpenAI (DALL-E 3) or Stability AI to enable the generate_image agent tool",
    keywords: [
      "image",
      "generation",
      "dall-e",
