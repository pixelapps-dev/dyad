...
const availableUpgrades: Omit<AppUpgrade, "isNeeded">[] = [
  {
    ...
    description:
      "Installs the Pagemate component tagger Vite plugin and its dependencies.",
    manualUpgradeUrl: "https://pagemate.dev/docs/upgrades/select-component",
  },
  {
    id: "capacitor",
    ...
    manualUpgradeUrl: "https://pagemate.dev/docs/guides/mobile-app#upgrade-your-app",
  },
];
...
async function applyComponentTagger(appPath: string) {
  ...
  try {
    ...
    await gitCommit({
      path: appPath,
      message: "[dyad] add Pagemate component tagger",
    });
