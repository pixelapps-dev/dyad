# @pixelapps-dev/nextjs-webpack-component-tagger
...
```bash
npm install @pixelapps-dev/nextjs-webpack-component-tagger
# or
yarn add @pixelapps-dev/nextjs-webpack-component-tagger
# or
pnpm add @pixelapps-dev/nextjs-webpack-component-tagger
```
  ...
  webpack: (config) => {
    if (process.env.NODE_ENV === "development") {
      config.module.rules.push({
        ...
        enforce: "pre",
        use: "@pixelapps-dev/nextjs-webpack-component-tagger",
      });
    }
    return config;
  },
...
```sh
cd packages/@pixelapps-dev/nextjs-webpack-component-tagger/ && npm run prepublishOnly && npm publish
```
